                                 ...
                                 <s.RadioItem isChose>
                                    <s.RadioItemLabel>
                                       <s.RadioLeft>
                                          <s.Radio />
                                          <p>
                                             Vận chuyển trong 2-4 ngày (trừ CN)
                                          </p>
                                       </s.RadioLeft>
                                       <p>
                                          {transferCost
                                 ...
                                 >
                                    <s.RadioItemLabel isBorder>
                                       <s.RadioLeft>
                                          <s.Radio />
                                          <p>
                                             Chuyển khoản ngân hàng (Miễn phí
                                             thanh toán)
                                          </p>
                                       </s.RadioLeft>
                                       <p></p>
                                    ...
                                    <s.RadioDesc>
                                       ...
                                       <span></span>
                                       <p>
                                          Ngân hàng: Vietcombank (TMCP Ngoại
                                          thương VN) – Chi nhánh Hội sở
                                       </p>
               ...
               <s.RightCenter>
                  <s.ToggleProducts>
                     ...
                     >
                        ...
                        {isShowProducts ? (
                           <p>
                              Ẩn thông tin đơn hàng <s.ChevronUpIcon />
                           </p>
                        ) : (
                           <p>
                              Hiển thị thông tin đơn hàng <s.ChevronDownIcon />
                           </p>
                        )}
                     </s.ToggleProductsLeft>
